    ...
    <>
      ...
      <li className="list-group-item border-0 ">
        <div className="btn-group dropend ">
          ...
          <button type="button"
            className="btn dropdown-toggle border-0 btn-outline-light col-12 text-start shadow-none fw-semibold text-secondary "
          ...
          <ul className="dropdown-menu">
            ...
            {departlists.map((departlist) => {
              return (
              <li key={departlist.id} className="dropdown-item" onClick={() => {handleRowClick(departlist.id)}}>{departlist.value}</li>
            )})}
